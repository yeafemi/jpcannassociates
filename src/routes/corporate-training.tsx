...
export const Route = createFileRoute("/corporate-training")({
  ...
  head: () => ({
    meta: [
      {
        title:
          "Corporate Training & Capacity Development — JPCann Associates Limited",
      },
      {
        name: "description",
        content:
          "Build skills that build your future. Practical, outcome-driven learning across Leadership, AI, GRC, ISO, and more.",
      },
    ],
  }),
});
...
const thematicAreas = [
  {
    ...
    topics:
      "Strategic leadership, team development, emotional intelligence, delegation, and conflict resolution",
    icon: Users,
    color: "text-blue-600",
    bg: "bg-blue-50",
  },
  {
    ...
    topics:
      "Talent acquisition, performance management, employee relations, HR analytics, and labour law compliance",
    icon: HeartHandshake,
    color: "text-rose-600",
    bg: "bg-rose-50",
  },
  {
    category: "ICT",
    topics:
      "IT essentials, systems administration, network fundamentals, and ICT policy development",
    icon: Cpu,
  ...
  },
  {
    ...
    topics:
      "Introduction to AI, prompt engineering, data visualization, business intelligence (Power BI, Tableau), and analytics",
    icon: Bot,
  ...
  },
  {
    ...
    topics:
      "Digital literacy, collaboration tools (Teams, Zoom, Slack), cloud productivity, and social media for business",
    icon: Monitor,
    color: "text-cyan-600",
    bg: "bg-cyan-50",
  },
  {
    ...
    topics:
      "Corporate governance frameworks, enterprise risk management, compliance program design, and internal audit practices",
    icon: ShieldCheck,
  ...
  },
  {
    ...
    topics:
      "Risk based auditing, audit evidence and documentation, audit reporting, and follow up processes",
    icon: Search,
  ...
  },
  {
    ...
    topics:
      "Credit analysis, lending operations, treasury management, customer service in banking, and regulatory compliance",
    icon: Landmark,
  ...
  },
  {
    ...
    topics:
      "Underwriting principles, claims management, actuarial fundamentals, pension fund administration, and industry regulations",
    icon: Shield,
    color: "text-red-600",
    bg: "bg-red-50",
  },
  {
    ...
    topics:
      "Financial reporting, management accounting, budgeting and forecasting, treasury management, and IFRS updates",
    icon: Calculator,
  ...
  },
  {
    ...
    topics:
      "Lead auditor and internal auditor courses for ISO 9001, 27001, 14001, 45001, and 22000",
    icon: FileBadge,
    color: "text-teal-600",
    bg: "bg-teal-50",
  },
  {
    ...
    topics:
      "Procurement, inventory control, warehouse management, transportation logistics, and supply chain optimization",
    icon: Truck,
    color: "text-sky-600",
    bg: "bg-sky-50",
  },
        ...
        <div className="mx-auto max-w-4xl px-4 text-center md:px-6">
          <Reveal variant="up">
            <h2 className="font-serif text-3xl md:text-5xl text-foreground mb-8">
              Capability,{" "}
              <span className="text-primary italic">Not Just Content.</span>
            </h2>
            <p className="text-xl text-muted-foreground leading-relaxed">
              We don't just deliver training. We build capability—tailored to
              your context, delivered through your preferred method, and
              designed to produce measurable performance improvement.
            </p>
          </Reveal>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          <Reveal className="mb-16 text-center" variant="up">
            <h2 className="font-serif text-3xl md:text-5xl mb-6">
              Thematic Areas We Cover
            </h2>
            <p className="text-lg text-muted-foreground">
              Curated learning across a wide range of disciplines, delivered by
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {thematicAreas.map((area, i) => (
              ...
              >
                ...
                <h3 className="font-serif text-xl mb-4 font-bold text-foreground">
                  {area.category}
                </h3>
              ...
              <div className="space-y-6">
                <div className="rounded-3xl border border-border bg-white p-8 shadow-sm transition-all hover:shadow-md">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Join scheduled courses with participants from multiple
                    organizations. Options available in your country and
                    internationally (e.g., Dubai, London, Accra).
                  </p>
                </div>
                <div className="rounded-3xl border border-border bg-white p-8 shadow-sm transition-all hover:shadow-md">
                  <h4 className="text-xl font-bold mb-4 flex items-center gap-3">
                    <Home className="text-accent" size={24} /> In-House &
                    Customized
                  </h4>
                  <p className="text-muted-foreground leading-relaxed">
                    Exclusive training designed around your organization's
                    specific strategy, processes, and challenges. Delivered on
                    your premises or our venue.
                  </p>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal variant="left">
                ...
                {[
                  {
                    title: "In-Person",
                    icon: Users,
                    desc: "Live interaction and group exercises.",
                  },
                  {
                    title: "Virtual Live",
                    icon: Video,
                    desc: "Instructor-led real-time sessions.",
                  },
                  {
                    title: "Blended",
                    icon: Laptop,
                    desc: "Self-paced + live workshops.",
                  },
                  {
                    title: "Self-Paced",
                    icon: BookOpen,
                  ...
                  <div
                    key={item.title}
                    className="rounded-3xl border border-border bg-slate-50 p-6 transition-all hover:bg-white hover:shadow-lg group"
                  >
              ...
              <div className="mt-8 rounded-3xl bg-slate-900 p-8 text-white">
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  We meet you where you are—in every sense. Our flexible
                  delivery models ensure that geography and schedule are never
                  barriers to capability building.
                </p>
              </div>
            </Reveal>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-3 lg:grid-cols-5">
            {whyJPCann.map((item, i) => (
              ...
              >
                ...
                <h4 className="font-bold mb-3 text-foreground leading-tight">
                  {item.title}
                </h4>
            ...
            <Reveal variant="right">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  <div
                    key={item}
                    className="flex items-center gap-4 p-4 rounded-xl border border-border bg-white shadow-sm"
                  >
                    <CheckCircle2
            ...
            <Reveal variant="left" className="relative">
              <div className="aspect-4/5 rounded-3xl bg-slate-900 p-12 text-white flex flex-col justify-center overflow-hidden">
                ...
                <h3 className="font-serif text-3xl md:text-4xl mb-8 relative">
                  Ready to Close Your <br />
                  <span className="text-primary italic">Skills Gap?</span>
                </h3>
            ...
            <div className="grid gap-6 md:grid-cols-2 relative">
              <div className="rounded-2xl bg-white/10 p-8 backdrop-blur-sm text-left border border-white/20">
                ...
                <p className="text-blue-100 mb-8 text-sm leading-relaxed">
                  Identify priority skill gaps and recommend the most
                  cost-effective mix (public, in-house, virtual).
                </p>
                <Link
                  to="/contact"
              ...
              <div className="rounded-2xl bg-white/10 p-8 backdrop-blur-sm text-left border border-white/20">
                ...
                <p className="text-blue-100 mb-8 text-sm leading-relaxed">
                  Ask for the latest schedule of local and international open
                  enrolment programs.
                </p>
                <Link
                  to="/trainings"
